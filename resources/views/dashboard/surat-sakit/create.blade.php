    ...
    <form action ="/sakit" method="post">
      ...
      <div class="card border-dark mb-3" >
        <div class="card-header text-center "><b><h3>
          Form Insert Surat Keterangan Sakit
        </h3></b></div>
        <d iv class="card-body">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="date" class="form-control @error('tgl_berakhir') is-invalid @enderror" id="tgl_berakhir" name="tgl_berakhir" value="{{old('tgl_berakhir')}}">
              @error('tgl_berakhir')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
